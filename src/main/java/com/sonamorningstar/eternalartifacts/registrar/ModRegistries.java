...
public class ModRegistries {
    ...
    public static final Registry<Multiblock> MULTIBLOCK = new RegistryBuilder<>(Keys.MULTIBLOCK).sync(true).create();
    ...
    public static final class Keys {
        ...
        public static final ResourceKey<Registry<Multiblock>> MULTIBLOCK = createRegistryKey("multiblock");
