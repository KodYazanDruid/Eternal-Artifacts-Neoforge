 ...
 */
public record FluidHolder<B extends LiquidBlock>(DeferredHolder<FluidType, ? extends FluidType> fluidTypeHolder,
                                                 DeferredHolder<Fluid, BaseFlowingFluid.Source> sourceHolder,
                                                 DeferredHolder<Fluid, BaseFlowingFluid.Flowing> flowingHolder,
                                                 @Nullable DeferredHolder<Item, BucketItem> bucketHolder,
                                                 @Nullable DeferredHolder<Block, B> blockHolder, int tintColor,
                                                 boolean genericTexture) implements ItemLike {
