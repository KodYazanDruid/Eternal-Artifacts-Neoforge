...
public class BioFurnaceMenu extends AbstractContainerMenu {
    public final BioFurnaceEntity blockEntity;
    ...
    public BioFurnaceMenu(int pContainerId, Inventory pPlayerInventory, BlockEntity pBlockEntity, ContainerData pData) {
        super(ModMenuTypes.BIOFURNACE.get() ,pContainerId);
        checkContainerSize(pPlayerInventory, 1);
        this.blockEntity = ((BioFurnaceEntity) pBlockEntity);
    ...
    public BioFurnaceEntity getBlockEntity() {
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()), pPlayer, ModBlocks.BIOFURNACE.get());
    }
    ...
    public static void openContainer(ServerPlayer player, BlockPos pos) {
        ...
        if (!(blockEntity instanceof BioFurnaceEntity bioFurnace))
            return;

        player.openMenu(bioFurnace, pos);
    }
}
