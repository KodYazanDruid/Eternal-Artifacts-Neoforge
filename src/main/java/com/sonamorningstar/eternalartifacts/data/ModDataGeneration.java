...
public class ModDataGeneration {
    ...
    public static void gatherData(GatherDataEvent event) {
        ...
        dataGenerator.addProvider(event.includeServer(), new PoiTypeTagsProvider(packOutput, lookupProvider, existingFileHelper));
        dataGenerator.addProvider(event.includeServer(), new AdvancementProvider(packOutput, lookupProvider, existingFileHelper));
    }
}
