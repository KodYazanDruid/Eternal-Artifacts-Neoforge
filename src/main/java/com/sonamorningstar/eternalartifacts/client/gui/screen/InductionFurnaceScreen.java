...
public class InductionFurnaceScreen extends AbstractSidedMachineScreen<InductionFurnaceMenu> {
    ...
    protected void init() {
        super.init();
        int currValue = menu.getBlockEntity() instanceof InductionFurnaceBlockEntity furnace ? furnace.recipeTypeId : 0;
        addRenderableWidget(new ExtendedSlider(leftPos + 100, topPos + 10, 50, 10, Component.empty(), Component.empty(),
            ...
            protected void applyValue() {
                if (menu.getBlockEntity() instanceof InductionFurnaceBlockEntity furnace) {
