...
import com.sonamorningstar.eternalartifacts.content.entity.projectile.ThrownLightningInABottleItem;
...
public class LightningInABottleItem extends Item {
	...
	public InteractionResultHolder<ItemStack> use(Level level, Player player, InteractionHand usedHand) {
		...
		if (!level.isClientSide) {
			ThrownLightningInABottleItem thrown = new ThrownLightningInABottleItem(level, player);
