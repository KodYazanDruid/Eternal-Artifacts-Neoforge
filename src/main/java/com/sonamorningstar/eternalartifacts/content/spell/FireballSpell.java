...
import com.sonamorningstar.eternalartifacts.content.entity.projectile.SpellSmallFireball;
...
public class FireballSpell extends AbstractProjectileSpell {
    ...
    protected Projectile createProjectile(Level level, LivingEntity caster, float amplifiedDamage, HitResult result, Vec3 shootVector) {
        return new SpellSmallFireball(level, caster, shootVector.x, shootVector.y, shootVector.z, amplifiedDamage);
    }
}
