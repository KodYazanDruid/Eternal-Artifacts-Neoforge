...
import com.sonamorningstar.eternalartifacts.content.entity.projectile.SpellSmallFireballProj;
...
public class FireballSpell extends AbstractProjectileSpell {
    ...
    protected Projectile createProjectile(Level level, LivingEntity caster, float amplifiedDamage, HitResult result, Vec3 shootVector) {
        return new SpellSmallFireballProj(level, caster, shootVector.x, shootVector.y, shootVector.z, amplifiedDamage);
    }
}
