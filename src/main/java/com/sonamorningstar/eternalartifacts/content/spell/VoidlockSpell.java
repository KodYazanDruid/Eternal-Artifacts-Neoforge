...
public class VoidlockSpell extends AbstractProjectileSpell {
	public VoidlockSpell(Properties props) {
		super(props);
	}
	...
	protected Projectile createProjectile(Level level, LivingEntity caster, float amplifiedDamage, HitResult result, Vec3 shootVector) {
		return new VoidlockSpellProj(level, caster, shootVector.x, shootVector.y, shootVector.z, amplifiedDamage);
	}
}
