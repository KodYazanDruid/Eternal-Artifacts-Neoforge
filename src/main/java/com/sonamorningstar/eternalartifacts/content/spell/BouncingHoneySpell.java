...
public class BouncingHoneySpell extends AbstractProjectileSpell {
	public BouncingHoneySpell(Properties props) {
		super(props);
	}
	...
	protected Projectile createProjectile(Level level, LivingEntity caster, float amplifiedDamage, HitResult result, Vec3 shootVector) {
		return new BouncingHoneySpellProj(level, caster, shootVector.x, shootVector.y, shootVector.z, amplifiedDamage);
	}
}
