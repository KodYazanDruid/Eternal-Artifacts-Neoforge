...
public class MachineWorkbenchBlockEntity extends MachineBlockEntity<MachineWorkbenchMenu> {
	public MachineWorkbenchBlockEntity(BlockPos pos, BlockState blockState) {
