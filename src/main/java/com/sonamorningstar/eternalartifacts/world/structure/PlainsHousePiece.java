...
public class PlainsHousePiece extends TemplateStructurePiece {
	public static final ResourceLocation STRUCTURE = new ResourceLocation(MODID, "plains_house");
	
	public PlainsHousePiece(StructureTemplateManager manager, BlockPos pos, Rotation rot, BlockPos pivotPos) {
		super(ModStructurePieces.PLAINS_HOUSE_PIECE.get(),
			0,
			manager,
	...
	public PlainsHousePiece(StructurePieceSerializationContext ctx, CompoundTag tag) {
		super(ModStructurePieces.PLAINS_HOUSE_PIECE.get(), tag, ctx.structureTemplateManager(), rl -> {
