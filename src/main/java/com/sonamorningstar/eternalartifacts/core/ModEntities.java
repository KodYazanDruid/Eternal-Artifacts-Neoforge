...
public class ModEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<SpellShulkerBullet>> SPELL_SHULKER_BULLET = ENTITY_TYPES.register("spell_shulker_bullet",
            ()-> EntityType.Builder.<SpellShulkerBullet>of(SpellShulkerBullet::new, MobCategory.MISC).sized(0.3125F, 0.3125F).clientTrackingRange(8).build("spell_shulker_bullet"));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<LightningStrikeProjectile>> LIGHTNING_STRIKE_PROJECTILE = ENTITY_TYPES.register("lightning_strike_projectile",
     ...
     public static final DeferredHolder<EntityType<?>, EntityType<SpellWitherSkull>> SPELL_WITHER_SKULL = ENTITY_TYPES.register("spell_wither_skull",
            ()-> EntityType.Builder.<SpellWitherSkull>of(SpellWitherSkull::new, MobCategory.MISC).sized(0.3125F, 0.3125F).clientTrackingRange(4).updateInterval(10).build("spell_wither_skull"));
