...
public class ModEntities {
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<SoulBlaze>> SOUL_BLAZE = ENTITY_TYPES.register("soul_blaze",
        ()-> EntityType.Builder.of(SoulBlaze::new, MobCategory.MONSTER).fireImmune().sized(0.6F, 1.8F).clientTrackingRange(8).build("soul_blaze"));
    public static final DeferredHolder<EntityType<?>, EntityType<MimicEntity>> MIMIC = ENTITY_TYPES.register("mimic",
        ()-> EntityType.Builder.of(MimicEntity::new, MobCategory.MONSTER).sized(14.0F / 16, 14.0F / 16).clientTrackingRange(8).build("mimic"));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<SpellSmallFireballProj>> SPELL_SMALL_FIREBALL = ENTITY_TYPES.register("spell_small_fireball",
            ()-> EntityType.Builder.<SpellSmallFireballProj>of(SpellSmallFireballProj::new, MobCategory.MISC).sized(0.3125f, 0.3125f).clientTrackingRange(4).updateInterval(10).build("spell_small_fireball"));
    public static final DeferredHolder<EntityType<?>, EntityType<SmallSoulFireball>> SOUL_SMALL_FIREBALL = ENTITY_TYPES.register("soul_small_fireball",
            ()-> EntityType.Builder.<SmallSoulFireball>of(SmallSoulFireball::new, MobCategory.MISC).sized(0.3125F, 0.3125F).clientTrackingRange(4).updateInterval(10).build("soul_small_fireball"));
    public static final DeferredHolder<EntityType<?>, EntityType<SpellShulkerBulletProj>> SPELL_SHULKER_BULLET = ENTITY_TYPES.register("spell_shulker_bullet",
            ()-> EntityType.Builder.<SpellShulkerBulletProj>of(SpellShulkerBulletProj::new, MobCategory.MISC).sized(0.3125F, 0.3125F).clientTrackingRange(8).build("spell_shulker_bullet"));
    public static final DeferredHolder<EntityType<?>, EntityType<SpellEvokerFangs>> SPELL_EVOKER_FANGS = ENTITY_TYPES.register("spell_evoker_fangs",
            ()-> EntityType.Builder.<SpellEvokerFangs>of(SpellEvokerFangs::new, MobCategory.MISC).sized(0.5F, 0.8F).clientTrackingRange(6).updateInterval(2).build("spell_evoker_fangs"));
    public static final DeferredHolder<EntityType<?>, EntityType<VoidlockSpellProj>> SPELL_VOIDLOCK = ENTITY_TYPES.register("spell_voidlock",
            ()-> EntityType.Builder.<VoidlockSpellProj>of(VoidlockSpellProj::new, MobCategory.MISC).sized(0.3125F, 0.3125F).clientTrackingRange(6).updateInterval(2).build("spell_voidlock"));
    public static final DeferredHolder<EntityType<?>, EntityType<BouncingHoneySpellProj>> SPELL_BOUNCING_HONEY = ENTITY_TYPES.register("spell_bouncing_honey",
            ()-> EntityType.Builder.<BouncingHoneySpellProj>of(BouncingHoneySpellProj::new, MobCategory.MISC).sized(0.3125F, 0.3125F).clientTrackingRange(6).updateInterval(2).build("spell_bouncing_honey"));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<AmethystArrow>> AMETHYST_ARROW = ENTITY_TYPES.register("amethyst_arrow",
        ()-> EntityType.Builder.<AmethystArrow>of(AmethystArrow::new, MobCategory.MISC).sized(0.5f, 0.5f).clientTrackingRange(4).updateInterval(20).build("amethyst_arrow"));
    public static final DeferredHolder<EntityType<?>, EntityType<PrismarineArrow>> PRISMARINE_ARROW = ENTITY_TYPES.register("prismarine_arrow",
        ()-> EntityType.Builder.<PrismarineArrow>of(PrismarineArrow::new, MobCategory.MISC).sized(0.5f, 0.5f).clientTrackingRange(4).updateInterval(20).build("prismarine_arrow"));
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<MagicMissileEntity>> MAGIC_MISSILE = ENTITY_TYPES.register("magic_missile",
        ()-> EntityType.Builder.<MagicMissileEntity>of(MagicMissileEntity::new, MobCategory.MISC).sized(0.25f, 0.25f).clientTrackingRange(4).updateInterval(10).build("magic_missile"));
