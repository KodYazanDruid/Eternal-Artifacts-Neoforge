...
public class ModRecipes {
    ...
    public static final RecipeDeferredHolder<SimpleFluidContainer, MobLiquifierRecipe> MOB_LIQUIFYING = RECIPES.register("mob_liquifying", MobLiquifierRecipe.Serializer::new);
