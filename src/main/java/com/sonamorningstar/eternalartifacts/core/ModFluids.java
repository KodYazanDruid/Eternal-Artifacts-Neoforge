...
public class ModFluids {
    ...
    public static final FluidDeferredHolder<BaseFluidType, BaseFlowingFluid.Source, BaseFlowingFluid.Flowing, BucketItem, PinkSlimeLiquidBlock> PINK_SLIME = FLUIDS.register(
    ...
    public static final FluidDeferredHolder<BaseFluidType, BaseFlowingFluid.Source, BaseFlowingFluid.Flowing, BucketItem, LiquidBlock> HOT_SPRING_WATER = FLUIDS.register(
